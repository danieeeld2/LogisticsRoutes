...
func TestAPI(t *testing.T) {
	...
	t.Run("TestAPIGets", func(t *testing.T) {
		matricula := "ABC123"
	...
	t.Run("TestAPIDeletes", func(t *testing.T) {
		var camion CamionMatricula
		matricula := "AAAAAA"
		url := server.URL + "/camion/" + matricula
	...
	t.Run("TestAPIPosts (Lógica de Negocio)", func(t *testing.T) {
		ID := "AAAAAA"
		url := server.URL + "/suministro/" + ID + "/asignacion"
	...
	t.Run("TestAPIPuts", func(t *testing.T) {
		var camion CamionMatricula
		camionData := Camion{
